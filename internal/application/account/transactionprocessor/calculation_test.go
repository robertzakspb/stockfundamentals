...
func Test_Recalculate_NilAccountId(t *testing.T) {
	...
	_, _, err := recalculateLotsAndCashBalances(account, transactions, lots)
...
func Test_Recalculate_SingleBuy_PositiveCase(t *testing.T) {
	...
	transactions := []transaction.Transaction{
		{Figi: "figi1", Timestamp: time.Now().AddDate(0, 0, -7), Quantity: 10, PricePerUnit: 25, Type: transaction.OrderExecution, Side: transaction.Buy, Currency: "USD"},
	}
...
func Test_Recalculate_MultipleBuys(t *testing.T) {
	...
	transactions := []transaction.Transaction{
		{Figi: "figi1", Timestamp: time.Now().AddDate(0, 0, -7), Quantity: 10, PricePerUnit: 25, Type: transaction.OrderExecution, Side: transaction.Buy, Currency: "USD"},
		{Figi: "figi1", Timestamp: time.Now().AddDate(0, 0, -6), Quantity: 2, PricePerUnit: 10, Type: transaction.OrderExecution, Side: transaction.Buy, Currency: "USD"},
		{Figi: "figi2", Timestamp: time.Now().AddDate(0, 0, -5), Quantity: 1, PricePerUnit: 25, Type: transaction.OrderExecution, Side: transaction.Buy, Currency: "USD"},
	}
...
func Test_Recalculate_SingleSell_OneLotIsClosed(t *testing.T) {
	...
	transactions := []transaction.Transaction{
		{Figi: "figi1", Timestamp: time.Now().AddDate(0, 0, -7), Quantity: 5, PricePerUnit: 25, Type: transaction.OrderExecution, Side: transaction.Sell, Currency: "USD"},
	}
...
func Test_Recalculate_SingleSell_OneFullCloseAndOnePartialClose(t *testing.T) {
	...
	transactions := []transaction.Transaction{
		{Figi: "figi1", Timestamp: time.Now().AddDate(0, 0, -7), Quantity: 5, PricePerUnit: 25, Type: transaction.OrderExecution, Side: transaction.Sell, Currency: "USD"},
		{Figi: "figi1", Timestamp: time.Now().AddDate(0, 0, -7), Quantity: 3, PricePerUnit: 25, Type: transaction.OrderExecution, Side: transaction.Sell, Currency: "USD"},
	}
